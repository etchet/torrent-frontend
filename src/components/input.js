...
const InputField = styled.input`
    width: ${props =>
        props.name === 'Search' ? '576px' :
        props.type === 'text' ? ' 450px;' :
        props.type === 'checkbox'? ' 14px;' :
        props.type === 'radio' ? '12px;' : '450px'
    };
    height: ${props =>
        props.type === 'text' ? ' 40px;' :
        props.type === 'checkbox'? ' 14px;' :
        props.type === 'radio' ? '12px;' : '40px'
    };
    background: #EEEEEE;
    ...
    padding-left: 20px; 
    margin-top: ${props =>
        props.type === 'radio' ? '3px;' : '0'
    };
    margin-right : ${props => 
    props.type === 'radio'  || 'checkbox' ? '12px' : '0'
    }
